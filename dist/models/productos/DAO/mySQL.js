...
class ProductosMYSQLDAO {
    ...
    getProductosById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.mySQL.select().table('productos').where({ id: id });
        });
    }
    search(data) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteProducto(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.mySQL('productos').where({ id: id }).del();
        });
    }
    updateProducto(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.mySQL('productos').where({ id: id }).update(data);
        });
    }
}
