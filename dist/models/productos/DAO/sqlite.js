...
class ProductosSQLiteDAO {
    ...
    getProductosById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sqlite.select().table('productos').where({ id: id });
        });
    }
    insertProducto(data) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteProducto(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sqlite('productos').where({ id: id }).del();
        });
    }
    updateProducto(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sqlite('productos').where({ id: id }).update(data);
        });
    }
}
