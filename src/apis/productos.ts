...
class prodAPI {
  ...
  async getProductosById(id:any):any {
        return this.productos.getProductosById(id);
  }

  async insertProducto(data:any):any {
      return this.productos.insertProducto(data);
  }

  async search(data:string):any {
    return this.productos.search(data);
  }

  async deleteProducto(data:any):any {
    return this.productos.deleteProducto(data);
   }

   async updateProducto(id:number, data:any):any {
